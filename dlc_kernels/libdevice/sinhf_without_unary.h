...
#ifndef _SINHF_WITHOUT_UNARY_H_X86_
#define _SINHF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_sinhf_without_unary(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        "pseudo@0       @pseudo imm_2 = 0;"
        "pseudo@0       @pseudo imm_3 = 32640;"
        "V0@(pr0)       vr0 = and.u32 vr6, r44;"
        "V1@(pr0)       vmsk1 = eq.s32 vr0, r45;"
        "}"
        "{"
        "V0@(pr0)       vr11 = mul.f32 vr0, r50;"
        "V1@(pr0)       vr12 = mov.u32 vr0;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 23007;"
        "pseudo@0       @pseudo imm_1 = 24375;"
        ...
        "}"
        "{"
        "V0@(pr0)       vr29 = sel vmsk0 vr11, vr17;"
        "V1@(pr0)       vr29 = sel vmsk1 vr29, vr12;"
        "}"
        "{"
        ...
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr3", "vr14", "vr11", "r1", "r0", "r3", "r9", "vmsk2", "vmsk1", "vmsk3", "vmsk0"
        );
    return result0;
}

#endif // _SINHF_WITHOUT_UNARY_H_
