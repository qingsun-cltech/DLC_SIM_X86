...
#ifndef _ERFCXF_WITHOUT_UNARY_H_X86_
#define _ERFCXF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_erfcxf_without_unary(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr3", "vr11", "vr14", "r0", "r9", "r1", "r3", "r6", "vmsk2", "vmsk1", "vmsk3", "vmsk0"
        );
    return result0;
}

#endif // _ERFCXF_WITHOUT_UNARY_H_
