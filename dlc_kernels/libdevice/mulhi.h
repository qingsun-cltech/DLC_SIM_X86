...
#ifndef _MULHI_H_X86_
#define _MULHI_H_X86_

inline int8_128 __dlc_mulhi(int8_128 a, int8_128 b)
{
    int8_128 result0;
    asm (
        ...
        "}"
        "{"
        "V0@(pr0)	vr31 = xor.u32 vr10, r56;"
        "V1@(pr0)	vr30 = xor.u32 vr11, r56;"
        "}"
        "{"
        "V0@(pr0)	vr2 = and.u32 vr10, r47;"
        "V1@(pr0)	vr3 = and.u32 vr11, r47;"
        "}"
        "{"
        "V0@(pr0)	vmsk7 = eq.s32 vr2, vr3;"
        "}"
        "{"
        "V0@(pr0)	vr31 = add.s32 vr31, r48;"
        "V1@(pr0)	vr30 = add.s32 vr30, r48;"
        "}"
        "{"
        "V0@(pr0)	vr10 = sel vmsk0 vr10, vr31;"
        "V1@(pr0)	vr11 = sel vmsk1 vr11, vr30;"
        "}"
        "{"
        ...
        "}"
        "{"
        "V0@(pr0)	vr10 = or.u32 vr6, vr5;"
        "}"
        "{"
        "V0@(pr0)	vr1 = xor.u32 vr10, r56;"
        "}"
        "{"
        "V0@(pr0)	vr1 = add.s32 vr1, r48;"
        "}"
        "{"
        "V0@(pr0)	%[res0] = sel vmsk7 vr1, vr10;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a),  [input1] "x" (b)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr3", "vr14", "vmsk0", "vmsk2", "vmsk1", "vmsk7"
        );
    return result0;
}
