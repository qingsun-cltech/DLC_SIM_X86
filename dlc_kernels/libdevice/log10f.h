...
#ifndef _LOG10F_H_X86_
#define _LOG10F_H_X86_

inline float8_128 __dlc_log10f(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        "pseudo@0       @pseudo imm_1 = 19456;"
        "V0@(pr0)       vr14 = mul.f32 vr10, r37;"
        "V1@(pr0)       vr13 = sub.s32 vr12, r32;"
        "}"
        "{"
        "V0@(pr0)       vr10 = sel vmsk0 vr10, vr14;"
        "V1@(pr0)       vr12 = sel vmsk0 vr12, vr13;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 23;"
        "V1@(pr0)       vr13 = shr.u32 vr10, r32;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 127;"
        "V0@(pr0)       vr13 = sub.s32 vr13, r32;"
        "V1@(pr0)       vr12 = add.s32 vr12, vr13;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 32768;"
        "pseudo@0       @pseudo imm_1 = 31;"
        "V0@(pr0)       vr14 = and.u32 vr13, r36;"
        "V1@(pr0)       vr14 = shr.u32 vr14, r33;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 127;"
        "V0@(pr0)       vr15 = mov.u32 r32;"
        "V1@(pr0)       vr15 = sub.s32 vr15, vr14;"
        "}"
        "{"
        ...
        "V1@(pr0)       vr15 = shl.u32 vr15, r34;"
        "}"
        "{"
        "V0@(pr0)       vr10 = or.u32 vr16, vr15;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 65535;"
        ...
        "{"
        "pseudo@0       @pseudo imm_0 = 128;"
        "V0@(pr0)       vmsk0 = ls.s32 vr11, vr11;"
        "V1@(pr0)       vr12 = mov.u32 r46;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 65535;"
        "pseudo@0       @pseudo imm_1 = 32767;"
        "V0@(pr0)       vr13 = and.u32 vr11, r44;"
        "V1@(pr0)       vmsk7 = eq.s32 vr13, r46;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 32640;"
        "V0@(pr0)       vmsk6 = ls.s32 vr11, r46;"
        "V1@(pr0)       vmsk5 = ls.s32 vr11, r36;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 25;"
        "pseudo@0       @pseudo imm_1 = 19456;"
        "V0@(pr0)       vr14 = mul.f32 vr11, r37;"
        "V1@(pr0)       vr13 = sub.s32 vr12, r32;"
        "}"
        "{"
        "V0@(pr0)       vr17 = sel vmsk0 vr11, vr14;"
        "V1@(pr0)       vr12 = sel vmsk0 vr12, vr13;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 23;"
        "V1@(pr0)       vr13 = shr.u32 vr17, r32;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 127;"
        "V0@(pr0)       vr13 = sub.s32 vr13, r32;"
        ...
        "}"
        "{"
        "V0@(pr0)       vr12 = add.s32 vr13, vr14;"
        "V1@(pr0)       vr12 = cvtinttof.f32 vr12;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 10203;"
        "pseudo@0       @pseudo imm_1 = 13652;"
        "V0@(pr0)       vr13 = mul.f32 vr12, r44;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 23513;"
        "pseudo@0       @pseudo imm_1 = 16094;"
        "V0@(pr0)       vr14 = mul.f32 vr10, r44;"
        "V1@(pr0)       vr13 = add.f32 vr13, vr14;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 8320;"
        "pseudo@0       @pseudo imm_1 = 16026;"
        "V0@(pr0)       vr14 = mul.f32 vr12, r44;"
        "V1@(pr0)       vr10 = add.f32 vr14, vr13;"
        "}"
        "{"
        "V1@(pr0)       vr12 = add.f32 vr11, vr11;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 32704;"
        "V0@(pr0)       vr10 = sel vmsk5 vr12, vr10;"
        "V1@(pr0)       vr10 = sel vmsk6 vr10, r36;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 65408;"
        "V0@(pr0)       %[res0] = sel vmsk7 vr10, r36;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr14", "vr3", "vmsk3", "vmsk0", "vmsk5", "vmsk4", "vmsk7", "vmsk1", "vmsk2", "vmsk6"
        );
    return result0;
}
