...
#ifndef _ERFINVF_H_X86_
#define _ERFINVF_H_X86_

inline float8_128 __dlc_erfinvf(float8_128 a)
{
    float8_128 result0;
    asm (
        "{V0@(pr0)  vr10 = mov.u32 %[input0];}"
        "{"
        "V0@(pr0)	vr11 = mul.f32 vr10, vr10;"
        "V1@(pr0)	vr11 = sub.f32 vr11, r49;"
        "}"
        "{"
        "V0@(pr0)	vr11 = mul.f32 vr11, r57;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 32640;"
        "V0@(pr0)	vmsk5 = ls.s32 vr11, r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 128;"
        "V0@(pr0)	vmsk4 = ls.s32 vr11, r36;"
        "V1@(pr0)	vr28 = mov.u32 r46;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 25;"
        "V0@(pr0)	vr29 = sub.s32 vr28, r32;"
        "V1@(pr0)	vr28 = sel vmsk4 vr28, vr29;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 19456;"
        "V0@(pr0)	vr29 = mul.f32 vr11, r36;"
        "V1@(pr0)	vr11 = sel vmsk4 vr11, vr29;"
        "}"
        "{"
        ...
        "}"
        "{"
        "V1@(pr0)	vr15 = sel vmsk0 vr31, vr7;"
        "}"
        "{"
        ...
        "V0@(pr0)	vr11 = sel vmsk3 vr1, vr2;"
        "V1@(pr0)	vr11 = sel vmsk7 vr11, r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65528;"
        "V0@(pr0)	vr11 = sel vmsk6 vr11, r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 62882;"
        "pseudo@0	@pseudo imm_1 = 12198;"
        "pseudo@0	@pseudo imm_2 = 58583;"
        "pseudo@0	@pseudo imm_3 = 13051;"
        "V0@(pr0)	vr12 = mul.f32 vr11, r44;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 62089;"
        "pseudo@0	@pseudo imm_3 = 13731;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 21487;"
        "pseudo@0	@pseudo imm_3 = 14318;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 21961;"
        "pseudo@0	@pseudo imm_3 = 14798;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 24687;"
        "pseudo@0	@pseudo imm_3 = 15174;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 21648;"
        "pseudo@0	@pseudo imm_3 = 15262;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 32691;"
        "pseudo@0	@pseudo imm_3 = 48775;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 2898;"
        "pseudo@0	@pseudo imm_3 = 16215;"
        "V0@(pr0)	vr12 = mul.f32 vr11, vr12;"
        "V1@(pr0)	vr12 = add.f32 vr12, r45;"
        "}"
        "{"
        ...
        "pseudo@0	@pseudo imm_2 = 55852;"
        "pseudo@0	@pseudo imm_3 = 13337;"
        "V0@(pr0)	vr13 = mul.f32 vr11, r44;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 51534;"
        "pseudo@0	@pseudo imm_3 = 13732;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 38365;"
        "pseudo@0	@pseudo imm_3 = 13298;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 34313;"
        "pseudo@0	@pseudo imm_3 = 47211;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 57165;"
        "pseudo@0	@pseudo imm_3 = 47386;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 45569;"
        "pseudo@0	@pseudo imm_3 = 15127;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 3878;"
        "pseudo@0	@pseudo imm_3 = 15421;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 38263;"
        "pseudo@0	@pseudo imm_3 = 48749;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 57284;"
        "pseudo@0	@pseudo imm_3 = 16226;"
        "V0@(pr0)	vr13 = mul.f32 vr11, vr13;"
        "V1@(pr0)	vr13 = add.f32 vr13, r45;"
        "}"
        "{"
        "V0@(pr0)	vr14 = sel vmsk0 vr13, vr12;"
        "V1@(pr0)	vmsk0 = gt.f32 vr10, r49;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "V0@(pr0)	vr11 = mul.f32 vr14, vr10;"
        "V1@(pr0)	vr11 = sel vmsk0 vr11, r44;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "V0@(pr0)	vmsk0 = ls.f32 vr10, r57;"
        "V1@(pr0)	vr11 = sel vmsk0 vr11, r44;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        ...
        "V1@(pr0)	vmsk0 = eq.f32 vr12, r49;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 32640;"
        "V0@(pr0)	%[res0] = sel vmsk0 vr11, r36;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr14", "vr3", "vmsk3", "vmsk0", "vmsk5", "vmsk4", "vmsk7", "vmsk1", "vmsk2", "vmsk6"
        );
    return result0;
}
