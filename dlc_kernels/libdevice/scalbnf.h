...
#ifndef _SCALBNF_H_X86_
#define _SCALBNF_H_X86_

inline float8_128 __dlc_scalbnf(float8_128 a, int8_128 b)
{
    float8_128 result0;
    asm (
        ...
        "V1@(pr0)	%[res0] = sel vmsk0 vr13, vr15;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a),  [input1] "x" (b)
        :"vr2", "vr1", "vr4", "vr5", "vr0", "vr11", "vr3", "vr15", "vr14", "vr7", "vr13", "vr10", "vr6", "vmsk1", "vmsk0"
        );
    return result0;
}
