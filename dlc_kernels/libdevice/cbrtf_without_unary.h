...
#ifndef _CBRTF_WITHOUT_UNARY_H_X86_
#define _CBRTF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_cbrtf_without_unary(float8_128 a)
{
    float8_128 result0;
    asm (
