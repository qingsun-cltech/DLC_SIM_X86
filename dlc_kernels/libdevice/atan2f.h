...
inline float8_128 __dlc_atan2f(float8_128 a, float8_128 b)
{
    float8_128 result0;
    asm (
        ...
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr3", "vr14", "vmsk1", "vmsk2", "vmsk3"
        );
    return result0;
}
