...
#ifndef _TGAMMAF_H_X86_
#define _TGAMMAF_H_X86_

inline float8_128 __dlc_tgammaf(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        "MTR@(pr0)	vr30 = pop urf;"
        "}"
        "{"
        "V0@(pr0)	(urf) = rcp.f32 vr30;"
        "V1@(pr0)	vmsk1 = ls.f32 vr10, r46;"
        "MTR@(pr0)	vr31 = pop urf;"
        "}"
        "{"
        "V0@(pr0)	vr30 = sel vmsk1 vr30, vr31;"
