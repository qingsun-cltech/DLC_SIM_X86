...
inline float8_128 __dlc_asinf_without_unary(float8_128 a)
{
    ...
    asm (
        ...
        "}"
        "{"
        "V0@(pr0)	vmsk5 = eq.f32 vr17, r49;"
        "V1@(pr0)	vmsk6 = gt.f32 vr17, r49;"
        "}"
        "{"
        ...
        "{"
        "V0@(pr0)	vr3 = mul.f32 vr2, vr2;"
        "V1@(pr0)	vmsk0 = lseq.f32 vr15, r46;"
        "}"
        "{"
        "V0@(pr0)	vr5 = mul.f32 vr1, vr3;"
        "V1@(pr0)	vr5 = sub.f32 vr4, vr5;"
        ...
        "V1@(pr0)	vr15 = sel vmsk0 vr15, r44;"
        "}"
        "{"
        "V0@(pr0)	vr15 = sel vmsk1 vr15, r46;"
        ...
        "}"
        "{"
        "V0@(pr0)	vr13 = sel vmsk0 vr1, vr7;"
        "V1@(pr0)	vr13 = sel vmsk1 vr13, vr2;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 48430;"
        "pseudo@0	@pseudo imm_1 = 45883;"
        ...
        "V0@(pr0)	vr10 = sel vmsk5 vr10, vr11;"
        "V1@(pr0)	%[res0] = sel vmsk6 vr10, r45;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a)
