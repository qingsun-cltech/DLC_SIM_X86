...
#ifndef _SINPIF_H_X86_
#define _SINPIF_H_X86_

inline float8_128 __dlc_sinpif(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr2", "vr5", "vr1", "vr4", "vr0", "vr3", "vr7", "vr11", "vr30", "vr28", "vr31", "vr10", "vr6", "vr12", "vr29", "vmsk1", "vmsk2", "vmsk3"
        );
    return result0;
}
