...
#ifndef _COSHF_WITHOUT_UNARY_H_X86_
#define _COSHF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_coshf_without_unary(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        "pseudo@0       @pseudo imm_2 = 0;"
        "pseudo@0       @pseudo imm_3 = 256;"
        "V0@(pr0)       vmsk0 = ls.s32 vr3, r32;"
        "V1@(pr0)       vr15 = mov.u32 r45;"
        "}"
        "{"
        ...
        "{"
        "pseudo@0       @pseudo imm_0 = 0;"
        "pseudo@0       @pseudo imm_1 = 48768;"
        "V0@(pr0)       vmsk0 = ls.f32 vr5, r44;"
        ...
        "pseudo@0       @pseudo imm_1 = 32767;"
        "pseudo@0       @pseudo imm_3 = 32640;"
        "V0@(pr0)       vr12 = and.u32 vr2, r44;"
        "V1@(pr0)       vmsk1 = eq.s32 vr0, r39;"
        "}"
        "{"
        "V0@(pr0)       vr13 = mul.f32 vr12, r50;"
        "V1@(pr0)       vr14 = mov.u32 vr12;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 23007;"
        "pseudo@0       @pseudo imm_1 = 24375;"
        "V0@(pr0)       vr15 = mov.u32 r44;"
        "V1@(pr0)       vr14 = shr.u32 vr14, r48;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 16320;"
        "V0@(pr0)       vr14 = sub.s32 vr15, vr14;"
        "V1@(pr0)       vr16 = mov.u32 r36;"
        "}"
        "{"
        "pseudo@0       @pseudo imm_0 = 32768;"
        "V0@(pr0)       vr15 = mul.f32 vr14, vr14;"
        "V1@(pr0)       vr28 = and.u32 vr2, r36;"
        "}"
        "{"
        "V0@(pr0)       vr17 = mul.f32 vr13, vr15;"
        "V1@(pr0)       vr17 = sub.f32 vr16, vr17;"
        "}"
        "{"
        "V0@(pr0)       vr17 = mul.f32 vr17, vr14;"
        "V1@(pr0)       vr14 = mov.u32 vr17;"
        "}"
        "{"
        "V0@(pr0)       vr15 = mul.f32 vr14, vr14;"
        "V1@(pr0)       vmsk0 = eq.f32 vr2, r46;"
        "}"
        "{"
        "V0@(pr0)       vr17 = mul.f32 vr13, vr15;"
        "V1@(pr0)       vr17 = sub.f32 vr16, vr17;"
        ...
        "{"
        "V0@(pr0)       vr17 = mul.f32 vr17, vr14;"
        "V1@(pr0)       vr14 = or.u32 vr28, r46;"
        "}"
        "{"
        "V0@(pr0)       vr13 = mul.f32 vr17, vr17;"
        "V1@(pr0)       vr13 = or.u32 vr28, vr13;"
        "}"
        "{"
        "V0@(pr0)       vr2 = sel vmsk0 vr13, vr29;"
        "V1@(pr0)       vr2 = sel vmsk1 vr2, vr14;"
        "}"
        "{"
        ...
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr3", "vr14", "vr11", "r1", "r0", "r3", "r9", "vmsk0", "vmsk3", "vmsk2", "vmsk1"
        );
    return result0;
}

#endif // _COSHF_WITHOUT_UNARY_H_
