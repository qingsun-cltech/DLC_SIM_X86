...
#ifndef _H_X86YPOTF_WITHOUT_UNARY_H_X86_
#define _H_X86YPOTF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_hypotf_without_unary(float8_128 a, float8_128 b)
{
    float8_128 result0;
    asm (
        ...
        "{"
        "pseudo@0	@pseudo imm_0 = 32640;"
        "V0@(pr0)	vr13 = and.u32 vr4, r47;"
        "V1@(pr0)	vr15 = or.u32 vr13, r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "V0@(pr0)	vr4 = mul.f32 vr17, vr14;"
        "V1@(pr0)	vr4 = sel vmsk5 vr4, r44;"
        "}"
        "{"
        "V0@(pr0)	vr4 = sel vmsk6 vr4, r46;"
        "V1@(pr0)	vr4 = sel vmsk7 vr4, vr15;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "pseudo@0	@pseudo imm_2 = 32640;"
        "V0@(pr0)	vr13 = and.u32 vr4, r44;"
        "V1@(pr0)	vmsk6 = eq.s32 vr13, r38;"
        "}"
        "{"
        "V0@(pr0)	vr14 = mul.f32 vr13, r50;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 23007;"
        "pseudo@0	@pseudo imm_1 = 24375;"
        "V0@(pr0)	vr15 = mov.u32 r44;"
        "V1@(pr0)	vr13 = shr.u32 vr13, r48;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 16320;"
        "V0@(pr0)	vr13 = sub.s32 vr15, vr13;"
        "V1@(pr0)	vr16 = mov.u32 r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 32768;"
        "V0@(pr0)	vr15 = mul.f32 vr13, vr13;"
        "V1@(pr0)	vr28 = and.u32 vr4, r36;"
        "}"
        "{"
        "V0@(pr0)	vr17 = mul.f32 vr14, vr15;"
        "V1@(pr0)	vr17 = sub.f32 vr16, vr17;"
        "}"
        "{"
        "V0@(pr0)	vr17 = mul.f32 vr17, vr13;"
        ...
        "{"
        "V0@(pr0)	vr17 = mul.f32 vr17, vr13;"
        "V1@(pr0)	vr13 = or.u32 vr28, r46;"
        "}"
        "{"
        "V0@(pr0)	vr14 = mul.f32 vr17, vr17;"
        "V1@(pr0)	vr14 = or.u32 vr28, vr14;"
        "}"
        "{"
        "V0@(pr0)	vr4 = sel vmsk5 vr14, vr29;"
        "V1@(pr0)	vr4 = sel vmsk6 vr4, vr13;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 61440;"
        ...
        "{"
        "pseudo@0	@pseudo imm_0 = 32640;"
        "V0@(pr0)	vr13 = and.u32 vr5, r47;"
        "V1@(pr0)	vr15 = or.u32 vr13, r36;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "V0@(pr0)	vr5 = mul.f32 vr17, vr14;"
        "V1@(pr0)	vr5 = sel vmsk5 vr5, r44;"
        "}"
        "{"
        "V0@(pr0)	vr5 = sel vmsk6 vr5, r46;"
        "V1@(pr0)	vr5 = sel vmsk7 vr5, vr15;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        "pseudo@0	@pseudo imm_2 = 32640;"
        "V0@(pr0)	vr13 = and.u32 vr5, r44;"
        "V1@(pr0)	vmsk6 = eq.s32 vr13, r38;"
        "}"
        "{"
        "V0@(pr0)	vr14 = mul.f32 vr13, r50;"
        ...
        "}"
        "{"
        "V0@(pr0)	vr5 = sel vmsk5 vr14, vr29;"
        "V1@(pr0)	vr5 = sel vmsk6 vr5, vr13;"
        "}"
        "{"
        ...
        :"vr4", "vr30", "vr10", "vr6", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr3", "vr14", "vmsk0", "vmsk5", "vmsk7", "vmsk1", "vmsk6"
        );
    return result0;
}

#endif // _HYPOTF_WITHOUT_UNARY_H_
