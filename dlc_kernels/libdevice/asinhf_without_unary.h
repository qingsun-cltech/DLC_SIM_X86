...
inline float8_128 __dlc_asinhf_without_unary(float8_128 a)
{
    ...
    asm (
        ...
        "}"
        "{"
        "V0@(pr0)	vr1 = mul.f32 vr12, r50;"
        "V1@(pr0)	vr2 = mov.u32 vr12;"
        "}"
        "{"
        ...
        "V1@(pr0)	vmsk0 = lseq.f32 vr12, r46;"
        "}"
        "{"
        ...
        "pseudo@0	@pseudo imm_2 = 0;"
        "pseudo@0	@pseudo imm_3 = 32640;"
        "V0@(pr0)	vr29 = and.u32 vr12, r44;"
        "V1@(pr0)	vmsk1 = eq.s32 vr29, r45;"
        "}"
        "{"
        "V0@(pr0)	vr1 = mul.f32 vr29, r50;"
        "V1@(pr0)	vr2 = mov.u32 vr29;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 23007;"
        "pseudo@0	@pseudo imm_1 = 24375;"
        ...
        "V1@(pr0)	vr31 = sel vmsk1 vr12, vr2;"
        "}"
        "{"
        "V1@(pr0)	vr12 = add.f32 vr31, vr0;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        ...
        "}"
        "{"
        "V0@(pr0)	vr14 = sel vmsk0 vr1, vr7;"
        "V1@(pr0)	vr14 = sel vmsk1 vr14, vr2;"
        "}"
        "{"
        "V0@(pr0)	vr14 = mul.f32 vr14, vr28;"
        "V1@(pr0)	vr14 = add.f32 vr14, vr0;"
        "}"
        "{"
        "V1@(pr0)	vr14 = add.f32 vr14, r49;"
        "}"
        "{"
        "V0@(pr0)	vmsk0 = gt.f32 vr0, r51;"
        "V1@(pr0)	vr14 = sel vmsk0 vr14, vr12;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 19840;"
        "V0@(pr0)	vmsk0 = gt.f32 vr0, r36;"
        "V1@(pr0)	vr14 = sel vmsk0 vr14, vr0;"
        "}"
        "{"
        ...
        "V1@(pr0)	vr10 = sel vmsk4 vr10, vr29;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 65535;"
        "pseudo@0	@pseudo imm_1 = 32767;"
        ...
        "V0@(pr0)	vr11 = and.u32 vr10, r38;"
        "V1@(pr0)	vr15 = add.f32 vr14, r44;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 19840;"
        "V0@(pr0)	vmsk0 = gt.f32 vr0, r38;"
        "V1@(pr0)	vr14 = sel vmsk0 vr14, vr15;"
        "}"
        "{"
        "V0@(pr0)	vmsk0 = infnan.f32 vr10;"
        "V1@(pr0)	vr12 = sel vmsk0 vr14, vr10;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 62154;"
        "pseudo@0	@pseudo imm_1 = 29001;"
        "V0@(pr0)	vr12 = or.u32 vr12, vr11;"
        "V1@(pr0)	vr13 = add.f32 vr10, r44;"
        "}"
        "{"
        "V0@(pr0)	vmsk0 = gt.f32 vr13, r49;"
        "V1@(pr0)	vr13 = sel vmsk0 vr12, vr10;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_0 = 12672;"
        "V0@(pr0)	vmsk0 = gt.f32 vr10, r36;"
        "V1@(pr0)	vr12 = sel vmsk0 vr13, vr12;"
        "}"
        "{"
        "V0@(pr0)	vmsk0 = eq.f32 vr10, r46;"
        "V1@(pr0)	%[res0] = sel vmsk0 vr12, r49;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr3", "vr14", "vr11", "vmsk3", "vmsk0", "vmsk5", "vmsk4", "vmsk7", "vmsk1", "vmsk2", "vmsk6"
        );
    return result0;
}

#endif // _ASINHF_WITHOUT_UNARY_H_
