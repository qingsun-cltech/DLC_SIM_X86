...
#ifndef _FAST_SINF_H_X86_
#define _FAST_SINF_H_X86_

inline float8_128 __dlc_fast_sinf(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr2", "vr1", "vr17", "vr4", "vr5", "vr16", "vr0", "vr11", "vr7", "vr15", "vr3", "vr14", "vr13", "vr10", "vr6", "vr12", "vmsk1", "vmsk2"
        );
    return result0;
}
