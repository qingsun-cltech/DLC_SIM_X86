...
#ifndef _TGAMMAF_WITHOUT_UNARY_H_X86_
#define _TGAMMAF_WITHOUT_UNARY_H_X86_

inline float8_128 __dlc_tgammaf_without_unary(float8_128 a)
{
    float8_128 result0;
    asm (
        ...
        "V1@(pr0)	vr10 = sel vmsk1 vr10, vr12;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 40;"
        "S1@(pr0)	r6 = sub.s32 r6, r34;"
        ...
        "}"
        "{"
        "V1@(pr0)	vmsk1 = ls.s32 vr11, r46;"
        "}"
        "{"
        "pseudo@0	@pseudo imm_2 = 40;"
        "S1@(pr0)	r6 = add.s32 r6, r34;"
        "V0@(pr0)	vr31 = mul.f32 vr30, r57;"
        "V1@(pr0)	%[res0] = sel vmsk1 vr30, vr31;"
        "}"
        : [res0] "=x" (result0)
        : [input0] "x" (a)
        :"vr4", "vr30", "vr10", "vr6", "vr12", "vr7", "vr15", "vr31", "vr1", "vr5", "vr0", "vr28", "vr13", "vr29", "vr2", "vr17", "vr16", "vr11", "vr3", "vr14", "r0", "r9", "r1", "r3", "r6", "vmsk3", "vmsk0", "vmsk5", "vmsk4", "vmsk7", "vmsk1", "vmsk2", "vmsk6"
        );
    return result0;
}

#endif // _TGAMMAF_WITHOUT_UNARY_H_
