...
inline float8_128 __dlc_sinf(float8_128 x)
{
    float8_128 res;
    ...
    res = v_f32_mul_b(kernel_cos_res, v_u32_move_f(-1));
    bool8_128 mask0 = v_s32_cmp(EQ, n, v_u32_move_i(0));
    res = v_f32_sel(mask0, res, kernel_sin_res);
    bool8_128 mask1 = v_s32_cmp(EQ, n, v_u32_move_i(1));
    res = v_f32_sel(mask1, res, kernel_cos_res);
    bool8_128 mask2 = v_s32_cmp(EQ, n, v_u32_move_i(2));
    res = v_f32_sel(mask2, res, v_f32_mul_b(kernel_sin_res, v_u32_move_f(-1)));
    ...
    res = v_f32_sel(mask, res, __kernel_sinf(x, z, 0));
...
inline float8_128 __dlc_sinf_libdevice(float8_128 a)
{
    float8_128 result0;
    asm (
